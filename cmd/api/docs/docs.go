...
const docTemplate = `{
    ...
    "paths": {
        "/api/v1/admin/chants": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Online chant",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/clap_internal_modules_chant_dto.SetOnlineChantRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/settings/chant-points": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/clap_internal_modules_chant_dto.UpdateChantPointsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/chants/{chant_id}/complete": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Chant ID, or song ID when source=catalog",
                        "name": "chant_id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "catalog or online (default online)",
                        "name": "source",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/chants/{chant_id}/lyrics": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "preview or main (logged only)",
                        "name": "mode",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        "clap_internal_modules_chant_dto.SetOnlineChantRequest": {
            "type": "object",
            "required": [
                "match_id",
                "scheduled_at",
        ...
        "clap_internal_modules_chant_dto.UpdateChantPointsRequest": {
            "type": "object",
            "properties": {
                "chant_daily_target": {
                    "type": "integer",
